...
static void create_achievement(game_t *game, quest_t *quest)
{
...
static void create_bar(quest_t *quest, const sfVector2u *size)
{
    quest->bar = sfRectangleShape_create();
    sfRectangleShape_setSize(quest->bar, (sfVector2f){0, 25});
